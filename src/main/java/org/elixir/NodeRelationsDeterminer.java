...
public class NodeRelationsDeterminer {
	...
	private static final ArrayList<String> transitionWords = new ArrayList<>(
			Arrays.asList("To make that", "in the first place", "again", "to", "moreover", "more", "not only",
					...
					"different from", "unlike", "whereas", "despite", "on the other hand", "yet", "conversely",
					"on the contrary",
					"otherwise", "at the same time", "albeit", "however", "in spite of", "besides", "rather", "even so ",
					...
					"in fact", "in general", "including this", "in this case", "for example", "for this reason",
					"for instance",
